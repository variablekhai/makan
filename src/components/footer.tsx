      ...
      <div className="container-custom mb-8">
        ...
        >
          <div className="text-center max-w-xl mx-auto">
            ...
            <p className="text-white text-lg mb-6">Sign up with your email address to receive new recipes each week.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h4 className="font-heading font-semibold text-lg mb-4">ABOUT MAKAN²</h4>
            <p className="text-muted-foreground mb-4">
              Welcome to Makan² food blog!
            </p>
            <p className="text-muted-foreground mb-4">
              Discover the rich flavors and unique recipes from our culinary journey. We share authentic dishes, cooking tips, and food reviews that bring people together around the table.
            </p>
          </div>

          <div>
            <h4 className="font-heading font-semibold text-lg mb-4">NAVIGATE</h4>
            <nav>
          ...
          <div>
            <h4 className="font-heading font-semibold text-lg mb-4">SUBSCRIBE TO OUR NEWSLETTER</h4>
            <p className="text-muted-foreground mb-4">
